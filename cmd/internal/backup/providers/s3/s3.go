...
func (b *BackupProviderS3) DownloadBackup(ctx context.Context, version *providers.BackupVersion, outputWriter io.Writer) error {
	bucket := aws.String(b.config.BucketName)
...
func (b *BackupProviderS3) UploadBackup(ctx context.Context, inputReader io.Reader, sourcePath string) error {
	bucket := aws.String(b.config.BucketName)
